...
| 贡献者总数（含匿名） | 577 |
| 可匹配身份贡献者数（登录名或匿名署名） | 576 |
| 可独立追踪开发者数（GitHub 登录） | 369 |
| 匿名但可匹配身份数 | 207 |
| 发现的共现项目数 | 2834 |
| 去噪后共现项目数 | 2813 |
| 每位开发者检索页数 | 1 |
...
| [project-trans/MtF-wiki](https://github.com/project-trans/MtF-wiki) | 8 | 25 | 1019 | @Dolyn157, @BingL-Li, @yinchao-qaq, @251nx, @AtomAlpaca, @artefaritaKuniklo |
...
| [devnghien/dayly](https://github.com/devnghien/dayly) | 5 | 8 | 1 | @Nigh, @MeguminSama, @ItsRqtl, @Sonic853, @YueMiyuki |
| [is-a-dev/register](https://github.com/is-a-dev/register) | 5 | 8 | 10033 | @Nigh, @MeguminSama, @ItsRqtl, @Sonic853, @YueMiyuki |
...
| [CFPAOrg/Minecraft-Mod-Language-Package](https://github.com/CFPAOrg/Minecraft-Mod-Language-Package) | 4 | 14 | 1129 | @HinataKato, @hedw1gP, @flemon-y, @MaribelHearm |
| [androidHarlan/ncnn](https://github.com/androidHarlan/ncnn) | 4 | 7 | 0 | @mizu-bai, @chisaki-takahashi, @PENGUINLIONG, @sunnycase |
| [project-trans/RLE-wiki](https://github.com/project-trans/RLE-wiki) | 4 | 4 | 229 | @artefaritaKuniklo, @GekkaSaori, @skitse, @SpartaEN |
...
| [KristallWang/Transgender-lost-years](https://github.com/KristallWang/Transgender-lost-years) | 3 | 13 | 379 | @BingL-Li, @KristallWang, @ann61c |
